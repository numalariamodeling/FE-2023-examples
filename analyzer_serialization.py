...
class InsetChartAnalyzer(IAnalyzer):
    ...
    def __init__(self, expt_name, sweep_variables=None, channels=None, working_dir=".", start_year=2022):
        ...
        self.inset_channels = channels or ['Statistical Population', 'New Clinical Cases',
...
if __name__ == "__main__":
    ...
    if step == 'pickup':
        sweep_variables = [
            'Run_Number']  # for times when you add additional items to the pickup, you can add more sweep variables here
